...
class XmlFile
{
    ...
    public function loadFromTempPath()
    {
        ...
        $this->fileObject->setFlags(SplFileObject::READ_XML | SplFileObject::SKIP_EMPTY | SplFileObject::DROP_NEW_LINE);
    }

    public function getHeaders()
    {
        $this->fileObject->rewind();
        $line = $this->fileObject->fgetxml();
        return $line;
    }
    ...
    /**
     * Use this to set the known (already-uploaded) xml file's path to where omekas puts it.
     */
